...
class Formulario104 extends Component
{
    use WithFileUploads;
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.reporte.formulario104', compact('data', 'acciones', 'rutasNombre', 'EmpresasNombre', 'dataEmpresas', 'tipoServicios', 'servicios'));
    }
