    ...
    <div class="card">
        <div class="card-body">
            <table class="table table-striped" style="width: 100%; border-collapse: collapse;">
                <tbody>
                    <thead>
                        <tr class="text-center" style="background-color: #6777ef; color: white; text-align: center;">
                            ...
                            <th style="border: 1px solid black;"><b>C&Oacute;DIGO</b></th>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid black; text-align: center;" class="text-center">{{$cat->codigo}}</td>
                ...
                <tfoot>
                    <td style="border: 1px solid black; text-align: center;" colspan="3"><b>VALOR TOTAL</b></td>
