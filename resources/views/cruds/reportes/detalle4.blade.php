    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 pull-left">
                <a class="btn btn-primary btn-sm text-white" href="/reportes/formulario4"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp; <b>Regresar</b></a>
            </div>

            <div class="col-lg-6 col-md-12 pull-right text-right">
                <a class="btn btn-success" href="/reportes/formulario4/generarPDF/{{$shop}}/{{$anio}}/{{$mes}}">
            ...
            <div class="row pull-right">
                <a class="btn btn-primary" id="generarXML" href="/reportes/formulario4/generarXML/{{$shop}}/{{$anio}}/{{$mes}}">
...
<script>
    function detalleFormulario(){
        ...
        window.location.href = "/reportes/formulario4/detalle/"+empresa+"/"+anio+"/"+mes;
    }
</script>
@endsection